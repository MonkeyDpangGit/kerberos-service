...
public class KerberosSocketClient implements KerberosClient {
    ...
    public FirstResponseWrapper getTgt(String name, long lifeTime) throws KerberosException {
        ...
        try {
            ...
            if (response instanceof String) {
                throw new TgsException(
                        "Ticket granting Server incurred an exception. The message information is" + response);
            } else {
    ...
    @Override
    public SecondResponseWrapper getSt(FirstResponseWrapper firstResponseWrapper, String clientName, String serverName,
            String ip, long lifeTime)
        ...
        try {
            ...
            if (clientName != null) {
                secondRequest = stClientProcessor
                        .getSecondRequest(firstResponseWrapper, clientName, serverName, ip, lifeTime);
            } else {
...
//			// 获取
            ...
            if (response instanceof String) {
                ...
                SecondResponseWrapper secondResponseWrapper = stClientProcessor
                        .getStResponse(secondResponse, firstResponseWrapper.getTgtResponse().getTgsSessionKey());
    ...
    @Override
    public SecondResponseWrapper getSt(FirstResponseWrapper firstResponseWrapper, String serverName, String ip,
            long lifeTime) throws KerberosException {
        return getSt(firstResponseWrapper, null, serverName, ip, lifeTime);
    }

    @Override
    public SecondResponseWrapper getSt(FirstResponseWrapper firstResponseWrapper, String clientName, String serverName,
            String ip) throws KerberosException {
