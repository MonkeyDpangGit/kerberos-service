...
public class KerberosFacadeTest {
    ...
    public void getServerRequest() {
        byte[] request = kerberosFacade.getThirdRequestByte("account-self");
        byte[] response = kerberosFacade.checkServiceTicket(request);
        boolean ok = kerberosFacade.checkServiceResponse(response, "account-self");
    ...
    public void getServerTwice() {
        ...
        request = kerberosFacade.getThirdRequestByte("account-self");
        response = kerberosFacade.checkServiceTicket(request);
        ok = kerberosFacade.checkServiceResponse(response, "account-self");
